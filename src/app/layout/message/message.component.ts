    ...
    this.apiService.sendMessage(dto)
      ...
      .subscribe(
        data => {
          ...
          if (0 < dto.merchantIdList.length && 0 < dto.terminalIdList.length) this.messageKind2 = '2-1';
          if (0 < dto.merchantIdList.length && 0 === dto.terminalIdList.length) this.messageKind2 = '2-2';
          if (0 === dto.merchantIdList.length && 0 < dto.terminalIdList.length) this.messageKind2 = '2-3';
