...
import { TerminalModel, FilterTerminal } from '../model/terminal-message.model';
import { TerminalMessageRest } from './terminal-message.rest';

export class TerminalMessageDataSource implements DataSource<TerminalModel> {
    private loadingSubject = new BehaviorSubject<boolean>(false);
    public subject = new BehaviorSubject<TerminalModel[]>([]);
    public totalSubject = new BehaviorSubject<string>(null);

    constructor(private rest: TerminalMessageRest) {}
